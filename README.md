...
<a id="services-in-amazon-bedrock-agentcore"></a>
...
<a id="amazon-bedrock-agentcore-runtime-host-agent-or-tools"></a>
...
<a id="deploying-an-ai-agent-with-bedrock-agentcore-runtime"></a>
...
<a id="what-happens-behind-the-scenes"></a>
### What happens behind the scenes? (နောက်ကွယ်မှာ ဘာတွေဖြစ်ပျက်နေသလဲ?)
...
<a id="deploying-an-mcp-server-with-bedrock-agentcore-runtime"></a>
...
<a id="deploying-an-a2a-servers-with-bedrock-agentcore-runtime"></a>
...
<a id="use-isolated-sessions-for-agents"></a>
...
<a id="understanding-ephemeral-context"></a>
...
<a id="handle-asynchronous-and-long-running-agents-with-amazon-bedrock-agentcore-runtime"></a>
...
<a id="asynchronous-processing-model"></a>
...
<a id="runtime-session-lifecycle-management"></a>
...
<a id="asynchronous-task-decorator"></a>
...
<a id="agentcore-runtime-lifecycle-events"></a>
...
<a id="agentcore-runtime-versioning-and-endpoints"></a>
...
<a id="amazon-bedrock-agentcore-memory-add-memory-to-your-agent"></a>
...
<a id="1-semantic-memory-strategy"></a>
...
<a id="2-user-preference-memory-strategy"></a>
...
<a id="agentcore-memory-integration"></a>
...
<a id="advance-agentcore-memory-pattern-memory-branching"></a>
...
<a id="key-benefits-for-multi-agent-systems"></a>
### Key Benefits for Multi-Agent Systems (Multi-Agent Systems အတွက် အဓိက အကျိုးကျေးဇူးများ)
...
<a id="how-the-memory-hook-provider-with-branch-support-works"></a>
...
<a id="building-the-agent-graph-with-parallel-execution-support"></a>
...
<a id="amazon-bedrock-agentcore-identity-provide-identity-management-for-agent-applications"></a>
...
<a id="how-it-works"></a>
### How It Works (အလုပ်လုပ်ပုံအဆင့်ဆင့်)
...
<a id="tagging-agentcore-identity-resources"></a>
...
<a id="control-access-based-on-tags"></a>
...
<a id="amazon-bedrock-agentcore-gateway-securely-connect-tools-and-other-resources-to-your-gateway"></a>
...
<a id="available-outbound-authorization-for-the-gateway"></a>
...
<a id="implement-lambda-function-tools-for-gateway"></a>
...
<a id="gateway-semantic-search"></a>
...
<a id="amazon-bedrock-agentcore-built-in-tools-interact-with-your-applications-using-built-in-tools"></a>
...
<a id="execute-code-and-analyze-data-using-amazon-bedrock-agentcore-code-interpreter"></a>
...
<a id="why-use-code-interpreter-in-agent-development"></a>
### Why use Code Interpreter in agent development (Agent တည်ဆောက်ရာတွင် Code Interpreter ကို ဘာကြောင့် သုံးသင့်သလဲ?)

စာသားသက်သက်ပဲ output ထုတ်ပေးတဲ့ agents တွေက တိကျသေချာတဲ့ logic (deterministic logic) တွေ လုပ်တဲ့အခါ အခက်အခဲ ရှိတတ်ပါတယ်ဗျာ -

* **Math Accuracy:** LLMs တွေက ရှုပ်ထွေးတဲ့ သင်္ချာတွက်ချက်မှုတွေမှာ မှားတတ်ပေမယ့် Code Interpreter သုံးရင်တော့ code ရေးပြီး တိတိကျကျ တွက်ချက်သွားနိုင်ပါတယ်ဗျ။
* **Data Processing:** CSV files တွေကို analysis လုပ်တာ၊ datasets တွေကို filter လုပ်တာနဲ့ statistics တွေကို dynamic တွက်ထုတ်တာတွေ လုပ်နိုင်ပါတယ်ဗျာ။
* **Visualization:** Matplotlib သုံးပြီး charts တွေ၊ plots တွေကို graph အနေနဲ့ visual ထုတ်ပေးနိုင်ပါတယ်လေ။
* **Logical Verification:** စဉ်းစားထားတဲ့ အဖြေတွေ မှန်/မမှန် စမ်းသပ်ဖို့ သို့မဟုတ် complex structures တွေကို parse လုပ်ဖို့ code ရေးပြီး verify လုပ်နိုင်ပါတယ်ဗျ။

<a id="interact-with-web-applications-using-amazon-bedrock-agentcore-browser"></a>
...
Browser Tool က managed container sandbox ထဲမှာ အလုပ်လုပ်တာ ဖြစ်ပါတယ်ဗျာ -

1. **Instantiation:** Agent က starting URL သို့မဟုတ် search query နဲ့အတူ browser tool ကို စတင် invoke လုပ်ပါတယ်။
2. **Headless Execution:** Sandboxed container ထဲမှာ headless Chromium browser တစ်ခု စတင်ပွင့်လာပါတယ်ဗျ။
3. **Action Mapping:** Agent က commands တွေ (ဥပမာ- `click(selector)`, `type(text)`) ကို ပေးပို့လှုပ်ရှားစေပါတယ်ဗျာ။
4. **Visual Feedback:** Browser က screenshots တွေနဲ့ DOM snapshots တွေကို ရိုက်ယူပြီး agent ဆီ ပြန်လည်ပေးပို့ပါတယ်လေ။
5. **State Persistence:** Task လုပ်ဆောင်နေစဉ်တစ်လျှောက်လုံး cookies နဲ့ storage state တွေကို ဆက်လက်ထိန်းသိမ်းပေးထားပါတယ်ဗျ။

ဒီ tool ကြောင့်မို့လို့ agent တွေဟာ web-based tasks တွေ (ဥပမာ - tickets booking လုပ်တာ၊ flights checking လုပ်တာ၊ internal wikis တွေ ရှာဖွေတာ) ကို လူကိုယ်တိုင် လုပ်ဆောင်နေသလိုမျိုး တိတိကျကျ လုပ်ဆောင်နိုင်တာ ဖြစ်ပါတယ်ဗျာ။

<a id="amazon-bedrock-agentcore-observability-observe-your-agents-and-resources"></a>
...
<a id="agentcore-gateway-cloudwatch-tracing"></a>
